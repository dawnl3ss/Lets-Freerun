...
class SpotManager {
    ...
    public static function add_spot(Spot $spot) : void {
        ...
        (new SQLSession())->write("INSERT INTO `spots` (name, tier, location, uid) VALUES ('{$spot->get_name()}', '{$spot->get_tier()}', '{$spot->get_location()->encode()}', '{$spot->get_uid()}')");
    }
    ...
    public static function remove_spot(Spot $spot) : void {
        ...
        (new SQLSession())->write("DELETE FROM `spots` WHERE uid = '{$spot->get_uid()}'");
    }
    ...
    public static function edit_spot(int $spot_id, Spot $new_instance) : void {
        ...
        (new SQLSession())->write("UPDATE `spots` SET name = '{$new_instance->get_name()}', tier = '{$new_instance->get_tier()}', location = '{$new_instance->get_location()->encode()}' WHERE uid = '{$spot_id}'");
    }
}