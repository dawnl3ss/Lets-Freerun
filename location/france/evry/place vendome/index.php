<?php
    ...
    foreach (SpotManager::$current_spots_list as $uid => $spots){
        if ($spots instanceof Spot) {
            if (strtolower($spots->get_name()) === "place vendome") $spot = $spots;
        }
    }
?>
<html>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <nav id="primary-nav" class="dropdown cf">
                                <span><a href="../../../../../Lets-Freerun"><img class="logo" src="../../../../image/logo.png" alt="banner_ogo"></span></a>
                                                    ...
                                                    foreach (SpotManager::$current_spots_list as $uid => $spot){
                                                        if ($spot instanceof Spot){
                                                            if ($spot->get_location()->get_country() === "United-States")
                                                                echo "<li><a href='../../../" . strtolower($spot->get_location()->get_country()) . "/" . strtolower($spot->get_location()->get_city()) . "/" . strtolower($spot->get_name()) . "'> {$spot->get_name()} </a></li>";
                                                        }
                                                    }
                                                    ?>
                                                </ul>
